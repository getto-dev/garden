...
export const metadata: Metadata = {
  ...
  description: "Полный справочник садовода: каталог культур, удобрения и препараты, уход за растениями, борьба с вредителями и болезнями",
  keywords: ["сад", "огород", "удобрения", "препараты", "посадка", "уход", "вредители", "болезни", "растения"],
  ...
  openGraph: {
    ...
    description: "Каталог культур, удобрения и препараты, уход за растениями",
  },
  twitter: {
    card: "summary_large_image",
    title: "Садовод",
    description: "Справочник садовода с удобрениями и препаратами",
  },
};
